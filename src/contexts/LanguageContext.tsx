...
const translations = {
  tr: {
    ...
    'about.title': 'Tarihçe',
    'about.subtitle': '1980 yılından bu yana tekstil makineleri sektöründe faaliyet gösteren Özver Mekatronik, müşterilerine en kaliteli hizmeti sunmaya devam ediyor.',
    'about.values.title': 'Değerlerimiz',
    'about.values.customer.title': 'Müşteri Odaklılık',
    'about.values.customer.description': 'Müşterilerimizin ihtiyaçlarını en iyi şekilde anlayarak, onlara özel çözümler sunuyoruz.',
    'about.values.quality.title': 'Kalite Güvencesi',
    'about.values.quality.description': 'Her projede en yüksek kalite standartlarını koruyarak, güvenilir hizmet sağlıyoruz.',
    'about.values.innovation.title': 'Teknolojik Yenilik',
    'about.values.innovation.description': 'Sürekli gelişen teknolojileri takip ederek, en güncel çözümleri müşterilerimize sunuyoruz.',
    'about.values.sustainability.title': 'Sürdürülebilirlik',
    'about.values.sustainability.description': 'Çevre dostu ve sürdürülebilir teknolojiler geliştirerek geleceğe yatırım yapıyoruz.',
    'about.stats.experience': 'Yıllık Deneyim',
    'about.stats.customers': 'Müşteri Sayısı',
    'about.stats.countries': 'Ülke Sayısı',
    'about.stats.projects': 'Proje Tamamlandı',
    'about.stats.experience.value': '40+',
    'about.stats.customers.value': '500+',
    'about.stats.countries.value': '25+',
    'about.stats.projects.value': '1000+',
    
    // Timeline
    'timeline.1980.content': 'Özver mekatronik kuruldu.',
    'timeline.1994.content': 'Mekanik ve endüstriyel hizmetlerimize başladık.',
    'timeline.2002.content': 'Makinalarımızı üretmeye başladık.',
    'timeline.2005.content': 'Yıllık 100.000 parça üretmeye başladık.',
    'timeline.2010.content': 'Kumaş ve iplik boyama makinelerini üretmeye başladık.',
    'timeline.2017.content': 'Yatırım yapılarımızı başlattık.',
    'timeline.2020.content': '25 ülkeye yüksek donanımlı ürünlerimizi hizmete sunuyoruz.',
    'timeline.2025.content': 'Alanında uzman personelimiz ile 90+ firmaya hizmet veriyoruz.',
  ...
  en: {
    ...
    'about.title': 'History',
    'about.subtitle': 'Özver Mechatronics, which has been operating in the textile machinery sector since 1980, continues to provide the highest quality service to its customers.',
    'about.values.title': 'Our Values',
    'about.values.customer.title': 'Customer Focus',
    'about.values.customer.description': 'We provide customized solutions by understanding our customers\' needs in the best way.',
    'about.values.quality.title': 'Quality Assurance',
    'about.values.quality.description': 'We provide reliable service by maintaining the highest quality standards in every project.',
    'about.values.innovation.title': 'Technological Innovation',
    'about.values.innovation.description': 'We offer the most up-to-date solutions to our customers by following constantly evolving technologies.',
    'about.values.sustainability.title': 'Sustainability',
    'about.values.sustainability.description': 'We invest in the future by developing environmentally friendly and sustainable technologies.',
    'about.stats.experience': 'Years of Experience',
    'about.stats.customers': 'Number of Customers',
    'about.stats.countries': 'Number of Countries',
    ...
    // Timeline
    'timeline.1980.content': 'Özver Mechatronics was founded.',
    'timeline.1994.content': 'We started our mechanical and industrial services.',
    'timeline.2002.content': 'We started manufacturing our machines.',
    'timeline.2005.content': 'We started producing 100,000 parts annually.',
    'timeline.2010.content': 'We started manufacturing fabric and yarn dyeing machines.',
    'timeline.2017.content': 'We started our investment structures.',
    'timeline.2020.content': 'We serve 25 countries with our high-tech products.',
    'timeline.2025.content': 'We serve 90+ companies with our expert staff.',
